...
then
  ...
  # exp_izone
  python scripts/planning_commonroad.py --model_path ${model10_path} --is_exp_mode 2 --planner_type izone_rela --prediction_mode default --algo_variable1 $2 --algo_variable2 $3 --algo_variable3 $4 --acc_mode const --acc_const_value $1 --reaction_traj_mode irule --predict_traj_mode_num 1 --solu_tag_str paramtest_izone-lrcirule$1[$2,$3,$4]_1.0_p1;
  wait
